...
class AppliancePatch(object):
    ...
    def site_url(self):
        """
        Gets the site_url of this AppliancePatch.
        URL of the site to use

        :return: The site_url of this AppliancePatch.
        :rtype: str
        """
    ...
    def site_url(self, site_url):
        """
        Sets the site_url of this AppliancePatch.
        URL of the site to use

        :param site_url: The site_url of this AppliancePatch.
        :type: str
        """
